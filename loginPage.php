    ...
    <form action="login_process.php" method="post" class="login-form">
      ...
      <div class="role-row">
        ...
        <div class="column">
          ...
          <label for="hod">HOD/CI</label>
        </div>
        <div class="column">
          <input type="radio" name="role" id="faculty" class="role" value="Watchman" required>
          <label for="faculty">Guard</label>
        </div>
  ...
  <footer>
    ...
    <ul>
      <li><a href=" https://github.com/moohiit"><i class="fab fa-github"></i> GitHub</a></li>
        <li><a href="https://www.linkedin.com/in/mohit-patel-51338a245"><i class="fab fa-linkedin"></i> LinkedIn</a>
        </li>
