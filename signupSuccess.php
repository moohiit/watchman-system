...
<body>
  <div class="card">
    ...
    <a id="login-link" style="font-size: larger; text-decoration: none;" href="loginPage.php"><center>Login</center></a>
  </div>
  <footer>
    <p>&copy; Watchman Syatem <br> Developed by Mohit Patel and Raman Goyal</p>
    <p>Contact us
    <ul>
