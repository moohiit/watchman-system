                ...
                <div class="content-row">
                  <p>Total Late Entry: <span>
                      ...
                      if ($fromDate && $toDate) {
                        ...
                        $sql1 = "SELECT COUNT(*) as count FROM inqury_data WHERE status='Late' AND dprt=?";
                      }
                  ...
                  <p>Total Early Exit: <span>
                      ...
                      if ($fromDate && $toDate) {
                        ...
                        $sql1 = "SELECT COUNT(*) as count FROM inqury_data WHERE status='Early' AND dprt=?";
                      }
                ...
                <div class="content-row">
                  <p>Total Other Checking Count: <span>
                      ...
                      if ($fromDate && $toDate) {
                        ...
                        $sql1 = "SELECT COUNT(*) as count FROM inqury_data WHERE status NOT IN ('Late', 'Early') AND dprt=?";
                      }
